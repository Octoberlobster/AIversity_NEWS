...
class Translate:
    ...
    def translate_pro_analyze(self,story_id):
        ...
        print("原始資料:", Category, Role, Analyze)
    ...
    def translate_topic(self, topic_id):
        ...
        for lang in self.lang_list:
            ...
            try:
                ...
                print("翻譯結果:")
                print("topic_title:", translated_topic_title)
                print("-" * 20)
                print("topic_short:", translated_topic_short)
                print("-" * 20)
                print("topic_long:", translated_topic_long)
                print("-" * 20)
                print("report:", translated_report)
                print("-" * 20)
                update_data = {
...
if __name__ == "__main__":
    ...
    for item in topic_id_list:
        print("開始翻譯topic_id:", item['topic_id'])
        translate.translate_topic(item['topic_id'])
