...
// domains 陣列移到 Header 函數內部

// languages 陣列移到 Header 函數內部
...
function Header() {
  ...
  // 定義語言選單陣列，使用 i18n 翻譯
  const languages = [
    { name: t('header.language.chinese'), code: 'zh' },
    { name: t('header.language.english'), code: 'en' },
    { name: t('header.language.japanese'), code: 'ja' },
    { name: t('header.language.korean'), code: 'ko' },
    { name: t('header.language.vietnamese'), code: 'vi' },
    { name: t('header.language.filipino'), code: 'fil' },
    { name: t('header.language.indonesian'), code: 'id' },
    { name: t('header.language.spanish'), code: 'es' },
    { name: t('header.language.french'), code: 'fr' },
    { name: t('header.language.german'), code: 'de' },
  ];
