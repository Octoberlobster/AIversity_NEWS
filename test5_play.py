        ...
        try:
            with sync_playwright() as p:
                ...
                try:
                    ...
                    tgurl = url + "&so=1"
                    page.goto(tgurl, wait_until='domcontentloaded', timeout=10000)
...
def main():
    ...
    news_categories = {
        ...
        # 新增美國分類
        "Politics": {
            "url": "https://news.google.com/topics/CAAqIQgKIhtDQkFTRGdvSUwyMHZNRFZ4ZERBU0FtVnVLQUFQAQ?hl=en-US&gl=US&ceid=US%3Aen",
        ...
        "Lifestyle & Consumer": {
            "url": "https://news.google.com/topics/CAAqIggKIhxDQkFTRHdvSkwyMHZNREUwWkhONEVnSmxiaWdBUAE?hl=en-US&gl=US&ceid=US%3Aen",
            "country": "United States of America"
        },
        "Sports": {
        ...
        # 新增印尼分類
        "Politics": {
            "url": "https://news.google.com/topics/CAAqIQgKIhtDQkFTRGdvSUwyMHZNRFZ4ZERBU0FtbGtLQUFQAQ?hl=id&gl=ID&ceid=ID%3Aid",
            "country": "Indonesia"
        },
        "International News": {
            "url": "https://news.google.com/topics/CAAqJggKIiBDQkFTRWdvSUwyMHZNRGx1YlY4U0FtbGtHZ0pKUkNnQVAB?hl=id&gl=ID&ceid=ID%3Aid",
            "country": "Indonesia"
        },
        "Science & Technology": {
            "url": "https://news.google.com/topics/CAAqJggKIiBDQkFTRWdvSUwyMHZNRGRqTVhZU0FtbGtHZ0pKUkNnQVAB?hl=id&gl=ID&ceid=ID%3Aid",
            "country": "Indonesia"
        },
        "Lifestyle & Consumer": {
            "url": "https://news.google.com/topics/CAAqIQgKIhtDQkFTRGdvSUwyMHZNR2hvWkdJU0FtbGtLQUFQAQ?hl=id&gl=ID&ceid=ID%3Aid",
            "country": "Indonesia"
        },
        "Sports": {
            "url": "https://news.google.com/topics/CAAqJggKIiBDQkFTRWdvSUwyMHZNRFp1ZEdvU0FtbGtHZ0pKUkNnQVAB?hl=id&gl=ID&ceid=ID%3Aid",
            "country": "Indonesia"
        },
        "Entertainment": {
            "url": "https://news.google.com/topics/CAAqJggKIiBDQkFTRWdvSUwyMHZNREpxYW5RU0FtbGtHZ0pKUkNnQVAB?hl=id&gl=ID&ceid=ID%3Aid",
            "country": "Indonesia"
        },
        "Business & Finance": {
            "url": "https://news.google.com/topics/CAAqJggKIiBDQkFTRWdvSUwyMHZNRGx6TVdZU0FtbGtHZ0pKUkNnQVAB?hl=id&gl=ID&ceid=ID%3Aid",
            "country": "Indonesia"
        },
        "Health & Wellness": {
            "url": "https://news.google.com/topics/CAAqIQgKIhtDQkFTRGdvSUwyMHZNR3QwTlRFU0FtbGtLQUFQAQ?hl=id&gl=ID&ceid=ID%3Aid",
            "country": "Indonesia"
        },
    }
    ...
    try:
        for category in selected_categories:
            ...
            # 处理该分类的新闻
            category_stories = process_news_pipeline(news_categories[category]["url"], news_categories[category]["country"], category)
