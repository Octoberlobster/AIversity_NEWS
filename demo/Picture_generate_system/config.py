...
# 基本設定
INPUT_JSON = os.path.join(os.path.dirname(__file__), "generated_news2.json")  # 輸入的新聞JSON檔案
OUTPUT_DIR = os.path.join(os.path.dirname(__file__), "generated_images_main")  # 輸出目錄
